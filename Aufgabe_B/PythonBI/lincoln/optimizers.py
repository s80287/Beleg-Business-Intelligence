...
class SGD(Optimizer):
    """Optimierer: Stochastischer Gradientenabstieg

    Args:
        lr (float): Startwert der Lernrate - Default ist 0.01
        final_lr (float): irrelevant - Default ist 0
        decay_type (str): irrelevant - Default ist None
    """
    def __init__(self,
                 lr: float = 0.01,
                 final_lr: float = 0,
...
class SGDMomentum(Optimizer):
    """Optimierer: Stochastischer Gradientenabstieg mit Momentum

    Args:
        lr (float): Startwert der Lernrate - Default ist 0.01
        final_lr (float): Zielwert der Lernrate - Default ist 0.
        decay_type (str): Art der Lernratenreduzierung (Werte: \'exponential\' oder \'linear\') - Default ist None.
        momentum (float): Momentum, das zur Lernratenreduzierung verwendet wird - Default ist 0.9. 
    """
    def __init__(self,
                 lr: float = 0.01,
                 final_lr: float = 0,
