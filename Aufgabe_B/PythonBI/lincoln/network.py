...
from lincoln.losses import Loss, MeanSquaredError
...
class NeuralNetwork(LayerBlock):
    """Neuronales Netz, bestehend aus Layern  und dessen Verlustfunktion
        
    Args:
        layers (List[Layer]): Liste der Layer des Netzes 
        loss (Loss): Verlustfunktion zur Bewertung der Güte des Netzes - Default ist MeanSquaredError.
