...
from lincoln.activations import Linear
from lincoln.base import Operation, ParamOperation
from lincoln.dense import WeightMultiply, BiasAdd
from lincoln.dropout import Dropout
...
class Dense(Layer):
    """Voll vernetztes vorwärts gerichtetes Layer
